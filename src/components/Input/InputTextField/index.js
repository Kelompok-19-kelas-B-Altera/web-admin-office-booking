  ...
  return(
    <div className="flex flex-col gap-[6px] mb-3 w-full">
      ...
      <input 
        ...
        className={`${disable ? "bg-[#F1F1F1] text-[#070723]/50" : "bg-white border-[#F1F1F1]"} border-[1px] p-[10px] rounded w-full focus:outline-none focus:bg-white focus:border-[#3A57E8]`}
