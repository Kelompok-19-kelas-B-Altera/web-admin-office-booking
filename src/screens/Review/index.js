...
const Review = () => {
  return (
    <ContentLayout>
      ...
      <ContentContainer>
        <EntriesAndSearchComponent />
        <div className="flex gap-[40px] h-[395px]">
          ...
          <div className="w-full">
            ...
            <p>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sapiente aperiam iusto quis.
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit quas, autem architecto
              harum obcaecati corrupti perferendis optio molestiae nesciunt recusandae!
            </p>
          </div>
        </div>
